    ...
    public ListenableFuture<Result> startWork() {
        ...
        return FluentFuture.from(TaskToFutureAdapter
                .getFutureWithTimeout(
                        ApiAvailabilityCheckUtils.isGMS(Tracing.currentContext) ? ExposureNotificationClientWrapper.get(getApplicationContext()).isEnabled() : null,
                        ApiAvailabilityCheckUtils.isHMS(Tracing.currentContext) ? ContactShieldWrapper.getInstance(getApplicationContext()).isEnabled() : null,
